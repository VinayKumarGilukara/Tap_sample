...
android {
    namespace = "com.example.tap_sample"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.tap_sample"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation (files("libs/knox.jar"))
    implementation (files("libs/nxpnfcandroidlib-1.9.aar"))
    implementation ("com.jakewharton.timber:timber:4.7.0")
    implementation ("androidx.appcompat:appcompat:1.4.1") // appcompat library
